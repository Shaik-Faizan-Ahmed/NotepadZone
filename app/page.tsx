...
export default function NotePadZone() {
  ...
  return (
    ...
    >
      ...
      {/* Combined Hero + Input Section */}
      <section className="min-h-screen w-full relative flex flex-col md:flex-row">
        {/* Left side: Welcome Message */}
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-4 py-12 text-center">
          <p className={`text-lg mb-4 ${isDark ? "text-gray-300" : "text-gray-600"}`}>Welcome back!</p>
          <h1 className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
            NotePadZone
          </h1>
          <p className={`text-lg md:text-xl italic ${isDark ? "text-gray-400" : "text-gray-500"}`}>
            Where your notes and links stay safe.
          </p>
        </div>

        {/* Right side: Input Box */}
        <div className="w-full md:w-1/2 flex items-center justify-center px-4 py-12 relative">
          {/* Background */}
          <div
